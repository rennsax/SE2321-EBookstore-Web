...
export default function BookInfo({
  abb, title, date, authors, price, isbn, intro, booksInCart, setBooksInCart }: BookInfoProps
) {
  ...
  const bought: boolean = booksInCart.filter(book => book.bookID === abb).length !== 0;
  ...
  return (
    <div className='book-details'>
      ...
      <div className='flex-space-between'>
        ...
        <button className={'book-details__btn' + (bought ? " book-details__btn--disable" : "")} onClick={handleClick} type='button'>
          {/* <span></span> */}
          <span className={'book-details__btn__cart' + (bought ? " book-details__btn__cart--end" : "")} ref={iconRef}>
            <Cart4 />
          </span>
          <span ref={textRef} className={'book-details__btn__text' + (bought ? " book-details__btn__text--added" : "")}>
